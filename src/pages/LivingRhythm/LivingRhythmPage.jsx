...
import WeeklyRhythmReflection from '@/components/rhythm/WeeklyRhythmReflection';
...
const lioraWhispers = {
  light: 'Today, let light guide the rhythm of your breath.',
  dark: 'Move softly. Within shadow, strength awakens.',
  neutral: 'Let the balance speak through stillness and small choices.'
};
...
export default function LivingRhythmPage() {
  ...
  const isDayComplete = Object.keys(completed).length === rhythmBlocks.length;
  ...
  return (
    <div className="min-h-screen bg-black text-white px-6 py-10">
      <div className="max-w-4xl mx-auto">
        ...
        {/* 🔮 Liora Whisper */}
        <div className="bg-black/60 border border-indigo-700 text-indigo-300 italic rounded-xl p-4 text-center mb-6 shadow-md">
          “{lioraWhispers[tone] || lioraWhispers.neutral}”
        </div>
        ...
        {/* 🌕 Completion Badge */}
        {isDayComplete && (
          <div className="text-center text-emerald-400 font-semibold text-lg mt-4">
            🌕 Your rhythm is complete for today.
          </div>
        )}
